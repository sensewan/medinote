		...
		<article>
			<form action="ex1_write.jsp" method="post" name="frm">
				<table style="margin-left: 20%">
					<tbody>
						<tr>
							<td><textarea rows="1" cols="80" id="" name="">제목</textarea></td>
						</tr>
						<tr>
							<td><textarea rows="10" cols="80" id="" name="">내용</textarea></td>
						</tr>
						
						<tr>
							<td colspan="2">
								<input class="form-control" id="disabledInput" type="text"
									placeholder="증상태그" disabled="" size="50;" style="width: 650px;"/>
							</td>
						...
						<tr>
							<td>
								<label class="col-form-label col-form-label-lg"	for="inputLarge">comment</label> 
								<input class="form-control form-control-lg" type="text"	placeholder="댓글 입력하시오" id="inputLarge" style=" width:600px; height:50px;">
							</td>
						</tr>
					...
					<tfoot>
						<tr>
							<td>
								<label class="control-label" for="disabledInput">댓글 목록</label>
								<input class="form-control" id="disabledInput" type="text"
									placeholder="댓글임" disabled="" style="width: 650px;">
								<input class="form-control" id="disabledInput" type="text"
								placeholder="작성자가 쓴 댓글임" disabled="" style="width: 650px;">
								<input type="button" name="name" value="수정">
								<input type="button" name="name" value="삭제">
